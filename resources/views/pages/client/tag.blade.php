                    ...
                    <div class="lg:col-span-4 md:col-span-5 col-span-12">
                        <aside class="sticky !top-[100px] block">
                            ...
                            <div class="mb-7.5 max-md:mt-7.5">
                                <h6 class="mb-5 text-black font-extrabold leading-[12px] uppercase relative align-middle text-lg font-nunito">Tentang Tag</h6>
                                <div class="p-5 border border-[#e9e9e9] text-center">
                                    <div class="w-16 h-16 bg-primary rounded-full mx-auto mb-4 flex items-center justify-center">
                                        <i class="fa-solid fa-hashtag text-white text-2xl"></i>
                                    </div>
                                    <h5 class="text-lg font-bold text-black font-nunito mb-2">#{{ $tag->name }}</h5>
                                    @if($tag->description)
                                        <p class="text-sm text-[#707070] leading-6">{{ $tag->description }}</p>
                                    @else
                                        <p class="text-sm text-[#707070] leading-6">Artikel dengan tag "{{ $tag->name }}".</p>
                                    @endif
                                </div>
                            </div>
