                    ...
                    <div class="lg:col-span-4 md:col-span-5 col-span-12">
                        <aside class="sticky !top-[100px] block">
                            ...
                            <div class="mb-7.5 max-md:mt-7.5">
                                <h6 class="mb-5 text-black font-extrabold leading-[12px] uppercase relative align-middle text-lg font-nunito">Tentang Penulis</h6>
                                <div class="p-5 border border-[#e9e9e9] text-center">
                                    <img class="w-20 h-20 rounded-full mx-auto mb-4" src="{{ $author->image ? getFile($author->image) : asset('dist/images/users/avatar-1.jpg') }}" alt="{{ $author->name }}">
                                    <h5 class="text-lg font-bold text-black font-nunito mb-2">{{ $author->name }}</h5>
                                    @if($author->bio)
                                        <p class="text-sm text-[#707070] leading-6">{{ $author->bio }}</p>
                                    @else
                                        <p class="text-sm text-[#707070] leading-6">Penulis artikel di website ini.</p>
                                    @endif
                                </div>
                            </div>
